...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\textit{Emergent Quantum Gravity -- \DTMnow\ -- Version 22k}}
...
This produces stronger attraction in high-\(\rho\) regions (mimicking dark matter clustering) and weaker attraction as \(\rho(t)\) dilutes cosmologically (mimicking evolving dark energy). This sign choice $1 - \eta \ell_p^3 \rho$ is motivated by damping increasing correlations (see Appendix~\ref{app:entropic_force_derivation}) -  Contains full symbolic verification).

This sign choice $1 - \eta \ell_p^3 \rho$ is motivated by damping increasing correlations (see Appendix~\ref{app:entropic_force_derivation}).
...
This $ w(z) $ is mildly phantom-like at $z∼1$, aligning with DESI DR2 ($w ≈ -0.95 ± 0.05$).
...
\begin{equation}
\addequation{Direc Energy}{eq:dirac_energy} 
...
\textit{Phys. Rev. Lett.} \textbf{127} (2021) 151301,
\url{https://arxiv.org/abs/2112.07961}.

\bibitem{BICEPKeck2024}
BICEP/Keck Collaboration,
BICEP/Keck. XVII. Constraints on Primordial Gravitational Waves from the BICEP/Keck 2021--2022 Observing Seasons,
arXiv:2407.04607 [astro-ph.CO] (2024),
\url{https://arxiv.org/abs/2407.04607}.

\bibitem{CMB-S4Forecasts2019}
CMB-S4 Collaboration,
CMB-S4 Decadal Survey APC White Paper,
arXiv:1907.04473 [astro-ph.CO] (2019),
\url{https://arxiv.org/abs/1907.04473}.

\bibitem{CMB-S42022}
CMB-S4 Collaboration,
Snowmass2021 CMB-S4 White Paper,
arXiv:2203.07638 [astro-ph.CO] (2022),
