...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\textit{Emergent Quantum Gravity -- \DTMnow\ -- Version 22h}}
...
\begin{equation}
\addequation{Deformed Face Amplitude}{eq:def_face_amplitude}
A_f(j_f) \to A_f(j_f) \,\exp\!\bigl(-\ell_p^3 \rho(t,x) \, j_f(j_f+1)\bigr).
\end{equation}
...
\begin{equation}
\addequation{EQG Face Amplitude Deformation}{eq:face_amplitude}
...
\begin{equation}
%\addequation{Volume Scaling}{eq:volume_scaling}
...
\begin{equation}
\addequation{Tensor Tilt Deviation}{eq:tensor_tilt_derivation}
...
\subsection{Proof of \texorpdfstring{$\sinh^{-3}$}{sinh\string^{-3}} Preference for Late-Time Acceleration} \label{proof:pref_for_late-time_acceleration}
\textbf{Lemma 5}:
...
\bibitem{des2026}
DES Collaboration, Year 6 Cosmology Results: Constraints on Dark Energy and Expansion from Combined Probes, arXiv:2601.14559 [astro-ph.CO] (2026), \url{https://arxiv.org/abs/2601.14559}.

\bibitem{des_y3_2021}
DES Collaboration, Year 3 Cosmology Results: Cosmological Parameters, \textit{Phys. Rev. D} \textbf{105} (2022) 023520, \url{https://arxiv.org/abs/2105.13549}.
